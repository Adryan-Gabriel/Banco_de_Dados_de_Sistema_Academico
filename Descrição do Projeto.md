...
RF01 – Cadastro de Base Unificada (Usuario): O sistema deve registrar os dados  fundamentais de qualquer pessoa na instituição, salvando Nome, CPF (único),  Telefone, E-mail (único) e Senha. 
...
RF09 – Controle de Matrícula em Cursos: O sistema deve gerenciar o vínculo do  aluno com o curso escolhido, registrando o Ano/Semestre de ingresso, a situação  atual (Ativo, Trancado, etc.), além de totalizar a carga horária e a frequência global  acumulada no curso. 
